...
class ResNet152Model(nn.Module):
    def __init__(self, num_classes=2, dropout_rate=3):
        ...
        self.resnet = torchvision.models.resnet50(weights=ResNet152_Weights.IMAGENET1K_V1)
...
class Trainer:
    def __init__(self, config):
        ...
        self.net = ResNet152Model().to(self.device)
    ...
    def train(self):
        ...
        for epoch in range(self.config['num_epochs']):
            ...
            torch.save(self.net.state_dict(
                            ...
                            f"Resnet152_modelTrainer_{epoch + 1}_acc={self.record_test[epoch]:.3f}.pt"))
            print("儲存權重完成")
        torch.save(self.net.state_dict(),
                   os.path.join(self.config['weight_path'], f"Resnet152_modelTrainer_full.pt"))
