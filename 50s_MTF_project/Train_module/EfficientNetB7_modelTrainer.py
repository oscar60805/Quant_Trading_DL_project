...
class EfficientNetB7Model(nn.Module):
    def __init__(self, num_classes=3):
        ...
        self.efficientnet = torchvision.models.efficientnet_b6(weights=EfficientNet_B7_Weights.DEFAULT)
...
class Trainer:
    def __init__(self, config):
        ...
        self.net = EfficientNetB7Model().to(self.device)
    ...
    def train(self):
        ...
        for epoch in range(self.config['num_epochs']):
            ...
            torch.save(self.net.state_dict(
                            ...
                            f"EfficientNetB7_modelTrainer_{epoch + 1}_acc={self.record_test[epoch]:.3f}.pt"))
            print("儲存權重完成")
        torch.save(self.net.state_dict(),
                   os.path.join(self.config['weight_path'], f"EfficientNetB7_modelTrainer_full.pt"))
